      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            Students explore colors, shapes, and textures, building creative foundations through play and curiosity.
          </p>
        </div>

        {/* Kindergarten Art Images */}
        <section className="mb-16">
          <h2 className="text-3xl font-serif italic text-center text-gray-800 mb-8">Kindergarten Art Images</h2>
            ...
            {kindergartenImages.map((image, index) => (
              <div key={index} className="bg-white rounded-lg shadow-lg overflow-hidden">
                <Image
                  ...
                  alt={`Kindergarten artwork ${index + 1}`}
                  width={400}
                  height={300}
        ...
        <section>
          <h2 className="text-3xl font-serif italic text-center text-gray-800 mb-8">Grades 1,2,3 Art Images</h2>
