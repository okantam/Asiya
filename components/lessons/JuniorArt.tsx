          ...
          {juniorArtworks.map((section, sectionIndex) => (
            ...
            >
              ...
              <ImageCarousel
                ...
                currentIndex={juniorImageIndexes[sectionIndex] || 0}
                setCurrentIndex={index => setJuniorImageIndex(sectionIndex, index)}
                autoSlide={autoSlideJunior[sectionIndex] || false}
                setAutoSlide={value => {
                  const newStates = [...autoSlideJunior];
